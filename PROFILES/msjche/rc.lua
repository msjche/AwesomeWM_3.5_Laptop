...
--	names = { "➊", "➋", "➌", "➍", "➎", "➏", "➐", "➑", "➒" },
	...
	layout = { layouts[10], layouts[7], layouts[8], layouts[10], layouts[4], layouts[7], layouts[10], layouts[1], layouts [1] }
		}
for s = 1, screen.count() do
...
----------------------------------------------------------------------------------------
-- Filesystems
boot_graph = blingbling.progress_graph({ height = 30,
					width = 95,
					v_margin = 5,
					horizontal = true,
					show_text = true,
...
root_graph = blingbling.progress_graph({ height = 30,
					width = 95,
					v_margin = 5,
					horizontal = true,
					show_text = true,
...
home_graph = blingbling.progress_graph({ height = 30,
					width = 95,
					v_margin = 5,
					horizontal = true,
					show_text = true,
...
netdown_graph = blingbling.line_graph({ height = 60,
                                        width = 70,
                                        show_text = true,
					font = "Droid Sans",
					font_size = "9",
...
netup_graph = blingbling.line_graph({ height = 60,
                                        width = 70,
                                        show_text = true,
					font = "Droid Sans",
					font_size = "9",
...
--    right_layout:add(wifiicon)
    ...
    myverticalwibox[s] = awful.wibox({ position = "left", screen = s, width = 95 })
...
--    awful.key({ altkey,           }, "b",      function () lain.widgets.battery:show(7) end),
	...
	awful.key({ modkey }, "i", function () awful.util.spawn( "google-chrome-stable -incognito") end),
